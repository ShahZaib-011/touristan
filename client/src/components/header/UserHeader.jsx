        ...
        <MDBNavbar color="bg-dark" fixed="top" dark expand="md" scrolling>
          ...
          <MDBCollapse isOpen={collapse} navbar>
            <MDBNavbarNav left>
              ...
              <MDBNavItem>
                <MDBNavLink to="/user/compare-trips">Compare Trips</MDBNavLink>
              </MDBNavItem>
            </MDBNavbarNav>
              ...
              <MDBNavItem>
                <MDBDropdown size="lg">
                  ...
                  <MDBDropdownMenu style={{ width: "225px" }}>
                    ...
                    <MDBDropdownItem href="/user/notifications">Notifications</MDBDropdownItem>
                    <MDBDropdownItem divider />

                    <MDBDropdownItem href="" onClick={onLogout}>Logout</MDBDropdownItem>
                  </MDBDropdownMenu>
                </MDBDropdown>
              </MDBNavItem>
            </MDBNavbarNav>
