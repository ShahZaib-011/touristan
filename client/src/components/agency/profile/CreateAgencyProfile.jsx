...
import { createProfile } from "../../../actions/agencyProfileActions";
...
const CreateAgencyProfile = (props) => {
  const { errors } = props;
  ...
  const handleChange = (e) => {
    ...
    setAgencyProfileData((prevState) => ({ ...prevState, [name]: value }));
  };
  const onSubmit = (e) => {
    e.preventDefault();
    const newagencyProfileData = agencyProfileData;
    props.createProfile(newagencyProfileData, props.history);
  };
  return (
...
export default connect(mapStateToProps, { createProfile })(
  withRouter(CreateAgencyProfile)
);
